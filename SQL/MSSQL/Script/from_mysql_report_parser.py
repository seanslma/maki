...
def main(argv):
    reports = [[dt] + parse_xml(os.path.join(dir,f'{folder}{dt}',report_file)) for dt in load_dt_names(dtfile)]
    cols = [dt_name, 'total_tables','tables_successfully_migrated','tables_partially_migrated','tables_failed_to_migrate']
